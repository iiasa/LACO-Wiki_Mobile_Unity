...
public class DottedLineExample : MonoBehaviour {
	...
	private void Start()
	{
		...
		coords[0] = new Vector2(40.210033f,16.363449f);//new Vector2(48.210033f, 16.363449f);//new Vector2();
		coords[1] = new Vector2(48.210033f, 16.363449f);
		coords[2] = new Vector2(40.210033f, 16.363449f);
		coords[3] = new Vector2(48.210033f, 16.363449f);
		coords [4] = new Vector2 (40.210033f, 16.363449f);
		/*
