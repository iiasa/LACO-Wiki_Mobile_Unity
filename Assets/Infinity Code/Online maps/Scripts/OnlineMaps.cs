...
#region Variables
    ...
    /// </summary>
    public const string version = "3.0.0.27";
    ...
    public float floatZoom
    {
        ...
        set
        {
            ...
            float z = Mathf.Clamp(value, 3, MAXZOOM);
    ...
    private void CheckBufferComplete()
    {
     ...
     //   Debug.Log("BufferCompleted allowRedraw: " + allowRedraw);
    ...
    private float CheckMapSize(float z)
    {
    ...
    private void CheckGoogleAPIQuery()
    {
        ...
        {
         //   Debug.Log("##### OnlineMapsGoogleAPIQuery");
