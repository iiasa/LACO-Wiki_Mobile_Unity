...
public abstract class OnlineMapsBuildingBase:MonoBehaviour
{
    ...
    protected static List<Vector3> GetLocalPoints(List<OnlineMapsOSMNode> nodes)
    {
        ...
        float sw = OnlineMapsUtils.tileSize * OnlineMapsTileSetControl.instance.sizeInScene.x / map.width * map.transform.lossyScale.x / zoomCoof;
        float sh = OnlineMapsUtils.tileSize * OnlineMapsTileSetControl.instance.sizeInScene.y / map.height * map.transform.lossyScale.z / zoomCoof;
