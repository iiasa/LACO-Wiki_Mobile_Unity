...
public class OnlineMapsTileSetControl : OnlineMapsControlBaseDynamicMesh
{
    ...
    [Obsolete("Use OnlineMapsMarkerFlatDrawer.OnGenerateMarkerVertices")]
    public Action<OnlineMapsMarker, List<Vector3>, int> OnGenerateMarkerVertices
    {
        get { return (markerDrawer as OnlineMapsMarkerFlatDrawer).OnGenerateMarkerVertices; }
        set { (markerDrawer as OnlineMapsMarkerFlatDrawer).OnGenerateMarkerVertices = value; }
    }

    [Obsolete("Use OnlineMapsMarkerFlatDrawer.OnSetMarkersMesh")]
    public Action<Mesh, Renderer> OnSetMarkersMesh
    {
        get { return (markerDrawer as OnlineMapsMarkerFlatDrawer).OnSetMarkersMesh; }
        set { (markerDrawer as OnlineMapsMarkerFlatDrawer).OnSetMarkersMesh = value; }
    }
    ...
    {
        return markerDrawer.GetMarkerFromScreen(screenPosition);
    }
