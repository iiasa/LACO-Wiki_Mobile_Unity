...
//	[RequireComponent(typeof(Graphic))] [NCDoc(19)]
	public class FitCameraToScreen : MonoBehaviour, IMeshModifier { //UPDATE //NCDOC
		...
		dim = new Vector2 (graphic.mainTexture.width, graphic.mainTexture.height);/*
			if (graphic.mainTexture != null) dim = graphic.mainTexture == NatCam.Preview ? Regularize(NatCam.Preview) : new Vector2(graphic.mainTexture.width, graphic.mainTexture.height);
